...
import FeedPost from "../images/lone-music/feed-post.png";
import LoginProfile from "../images/lone-music/login-profile.png";
import FeedPage from "../images/lone-music/feed.png";
import NewPostPage from "../images/lone-music/new-post.png";
...
<Image src={FeedPost} alt="feed and post pages" />

<Image src={LoginProfile} alt="login and profile pages" />
...
<Image src={FeedPage} alt="feed page" />

<Image src={NewPostPage} alt="new post page" />
