...
import OldBuild from "../images/building-my-pc/old-build.png";
import BuildToday from "../images/building-my-pc/new-build.png";
...
<Image src={OldBuild} alt="old pc build" />
...
<Image src={BuildToday} alt="new pc build" />
