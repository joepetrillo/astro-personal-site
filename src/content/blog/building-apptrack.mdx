...
import Diagram from "../images/app-track/diagram.png";
import Unsubscribe from "../images/app-track/unsub.png";
...
<Image src={Unsubscribe} alt="unsubscribe user interface" />
